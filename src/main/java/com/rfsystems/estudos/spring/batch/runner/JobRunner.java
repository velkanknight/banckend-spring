package com.rfsystems.estudos.spring.batch.runner;

import com.rfsystems.estudos.spring.batch.utils.Constants;
...
public class JobRunner {
    ...
    public void runBatchJob() {
        ...
        jobParametersBuilder.addString(Constants.FILE_NAME_CONTEXT_KEY, "acess.log");
